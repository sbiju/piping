...
from .forms import EmployeeCreateForm, WelderCreateForm, FabricatorCreateForm, SupervisorCreateForm, \
    EngineerCreateForm
...
#     def get_queryset(self):
#         qs = Welder.objects.all()
#         if self.q:
#             qs = qs.filter(welder_no__istartswith=self.q)
#         return qs
